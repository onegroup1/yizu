              ...
              <form data-name="login" class="ui-form" method="post" action="/yizu/one/index.php/home/logins/login" id="login">
                <fieldset>
                  ...
                  <div class="ui-form-item">
                    	...
                    	<input class="ui-input" type="text" maxlength="48" onKeyDown="if (this.value.length>=48 ){event.returnValue=false}" name='j_username' id="j_username" value="18739761136" data-is="isMobileOrEmail" autocomplete="off" />

                    <p class="placeholder">请输入手机号/邮箱</p>
                  </div>
                  <div class="ui-form-item">
                    <input class="ui-input "  type="password" placeholder="请输入密码" value="123456" name='login_pwd' data-is="isEmail" />
