...
<div id="wdg-loan-list" class="main-section content-section index-card loan-list-card">
    <div class="card-caption">
        ...
        <div class="more-wrap">
            <a target="_self" href="/yizu/one/index.php/home/creditor/zhaiw">查看更多&gt; </a>
        </div>
    </div>
    <div class="card-detail">
...
<a class="fn-left w116 rrd-dimgray fn-text-overflow" title="<?php echo ($vo["creditor_name"]); ?>" target="_blank" href="/yizu/one/index.php/Home/Index/zhaiqxq/id/<?php echo ($vo["creditor_id"]); ?>/cred/<?php echo ($vo["jindu"]); ?>"><?php echo ($vo["creditor_name"]); ?></a>
</span>
...
<?php else: ?>
        <a href="/yizu/one/index.php/home/index/xinjihua" class="ui-button j-btn j-btn-orange ui-list-invest-button ui-list-invest-button-OPEN">
