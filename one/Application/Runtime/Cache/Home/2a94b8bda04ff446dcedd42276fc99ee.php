...
<html><head>
        ...
        <link rel="stylesheet" href="/one/Public/css/video-js_f377876.css"/>
        ...
        <script src="/one/Public/js/video_41dc322.js"></script>

        <script>
            weLogger.init({ platform : 'pc' });
            weLogger.perf.headStart( _jHeadStart );
        </script>
    <link rel="stylesheet" type="text/css" href="/one/Public/css/common_widget_a1e249e.css" /><link rel="stylesheet" type="text/css" href="/one/Public/css/invest_widget_5739d14.css" /><link rel="stylesheet" type="text/css" href="/one/Public/css/index_358777c.css" /><link rel="stylesheet" type="text/css" href="/one/Public/css/home_widget_9fe32bd.css" /></head>
<body class="body">
    <script>
...
<div class="index-banner content-section">
  ...
  <ul id="slides" class="ui-slides">
    	...
    	<li class="ui-slide01 fn-hide" data-background="url(/one/Public/img/1.jpg) no-repeat 50% 50%" style="background-image: url(/upload/cms/banner/indexBanner/08437a94-89b5-4586-b237-da3a73b8bd30.jpg?20140401a); display: none; background-position: 50% 50%; background-repeat: no-repeat no-repeat;">

          <a  href="http://www.we.com/event/eventPage.action?type=wealth"  target="_blank"></a>

        </li>

	<li class="ui-slide01 fn-hide" data-background="url(/one/Public/img/2.jpg?20140401a) no-repeat 50% 50%" style="background-image: url(/upload/cms/banner/indexBanner/4917ea1b-c60c-48d2-9ad5-1ff55894ab49.jpg?20140401a); display: none; background-position: 50% 50%; background-repeat: no-repeat no-repeat;">
...
<div class="fn-hide">
  ...
  <div id="weixin" class="p20 text-center">
    ...
    <img src="/one/Public/images/weixin_l.jpg" />
