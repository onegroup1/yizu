...
<link href="/yizu/one/Public/admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/yizu/one/admin.php/Home/Index/alogin" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
         ...
         <img src="/yizu/one/admin.php/Home/Index/verify" id="img">
...
<script type="text/javascript">
  //验证码变化
  function fun(){
    document.getElementById('img').src="/yizu/one/admin.php/Home/Index/verify/"+Math.random();
  }
</script>
</body>
</html>