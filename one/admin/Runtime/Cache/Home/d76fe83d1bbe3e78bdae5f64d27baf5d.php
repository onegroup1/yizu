...
<body>
<div class="pd-20">
    <form action="/one/admin.php/Home/Creditor/cr_up" method="post" class="form form-horizontal" id="form-member-add">
        <input type="hidden" value="<?php echo ($arr['creditor_id']); ?>" name="id">
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>借款标题：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="<?php echo ($arr['creditor_name']); ?>" placeholder=""  name="creditor_name" datatype="*2-16">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="<?php echo ($arr['creditor_lilv']); ?>" placeholder="" name="creditor_lilv" datatype="*2-16">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="<?php echo ($arr['creditor_money']); ?>" placeholder=""   name="creditor_money" datatype="*2-16">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="<?php echo ($arr['creditor_deadline']); ?>" placeholder="" name="creditor_deadline"  datatype="*2-16">
            </div>
            <div class="col-4"> </div>
        </div>
